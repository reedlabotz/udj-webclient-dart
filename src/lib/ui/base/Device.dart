...
class Device {
   ...
   */
  static RegExp _IPHONE_REGEX = new RegExp('iPhone|iPod');

  /**
   * The regular expression for detecting an iPhone or iPod or iPad.
   */
  static RegExp _MOBILE_SAFARI_REGEX = new RegExp('iPhone|iPod|iPad');

  /**
   * The regular expression for detecting an iPhone or iPod or iPad simulator.
   */
  static RegExp _APPLE_SIM_REGEX = new RegExp('iP.*Simulator');
